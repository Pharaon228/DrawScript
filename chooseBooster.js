...
async function getBalanceAndChoices(page, id) {
  let balance = 0;
  balanceValue = await page.waitForSelector(
  ...
  const choices = [
    { level: "без бустера", cost: 0, link: "" },
    {
      level: "первого",
      cost: 1000,
      link: 'a.ShopItemStyled-xpqzty-0.kKtMTi[href="/shop/0"]',
    },
    {
      level: "второго",
      cost: 3000,
      link: 'a.ShopItemStyled-xpqzty-0.leGwGs[href="/shop/1"]',
    },
    {
      level: "третьего",
      cost: 10000,
      link: 'a.ShopItemStyled-xpqzty-0.TudwE[href="/shop/2"]',
    },
    {
      level: "четвёртого",
      cost: 20000,
      link: 'a.ShopItemStyled-xpqzty-0.jnUyLC[href="/shop/3"]',
    },
  ];
